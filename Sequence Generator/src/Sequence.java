...
//
// Title: Sequence.java
// Files: ArithmeticSequenceGenerator.java, GeometricSequenceGenerator.java,
  ...
  public Sequence(int[] command) {
    ...
    switch (sequenceType) {
      ...
      case GEOMETRIC:
        ...
        // an iterator over geometric sequence with initial element command[1], common
      ...
      case FIBONACCI:
        ...
        break;
      case DIGIT_PRODUCT:
        // call the constructor of the DigitProductSequenceGenerator class to create
        // an iterator over digitproduct sequence with initial element command[1], and size stored
        // at command[2]
